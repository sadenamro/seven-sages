...
const SevenSages = () => {
  ...
  const handleAskSage = async () => {
    ...
    try {
      ...
      setChatResponse("عذراً يا بني، لم تصلني رسالتك عبر الأزمان.");
    } finally {
      setIsChatLoading(false);
    }
  };
    ...
    <div className="min-h-screen bg-slate-50 font-sans text-slate-800 selection:bg-amber-200" dir="rtl">
      ...
      <header className="relative bg-slate-900 text-white overflow-hidden pb-24">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 pt-20 text-center">
          ...
          <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-amber-200 via-white to-amber-200" style={{ fontFamily: "'Amiri', serif" }}>
      ...
      <main className="relative z-20 -mt-20 max-w-7xl mx-auto px-6 pb-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          ...
          {/* Intro Card */}
          <div className="bg-white rounded-2xl p-8 shadow-xl border-t-4 border-slate-800 flex flex-col justify-center items-center text-center lg:col-span-3 xl:col-span-1 mb-4 xl:mb-0 bg-opacity-90 backdrop-blur-sm">
